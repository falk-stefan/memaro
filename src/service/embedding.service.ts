...
export const embedQuery = (text: string): Promise<number[]> => runEmbedding(`search_query: ${text}`);

export const embedDocument = (text: string): Promise<number[]> => runEmbedding(`search_document: ${text}`);
